...
var motorsAgent = new OpenAIClient(apiKey)
  ...
  .AsAIAgent("""
    ...
    HumanAgent's verdict is the ONLY one that matters for execution:
    ...
    # CONSTRAINTS
    - NEVER execute a sequence unless HumanAgent's most recent message says APPROVED.
    - NavigatorAgent's verdict NEVER overrides or delays a HumanAgent APPROVED.
    """,
    "MotorsAgent",
